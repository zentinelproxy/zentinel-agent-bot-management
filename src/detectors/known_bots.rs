...
impl KnownBotDatabase {
        ...
        vec![
            CompiledBot {
                ...
                ua_patterns: vec![
                    ...
                    Regex::new(r"(?i)google-inspectiontool").unwrap(),
                    Regex::new(r"(?i)googleother").unwrap(),
                ],
                ip_ranges: vec![
                    "66.249.64.0/19".parse().unwrap(),
                    "64.233.160.0/19".parse().unwrap(),
                    "66.102.0.0/20".parse().unwrap(),
                    "72.14.192.0/18".parse().unwrap(),
                    "74.125.0.0/16".parse().unwrap(),
                    "209.85.128.0/17".parse().unwrap(),
            ...
            CompiledBot {
                ...
                ua_patterns: vec![
                    ...
                    Regex::new(r"(?i)msnbot").unwrap(),
                ],
                ip_ranges: vec![
                    "40.77.167.0/24".parse().unwrap(),
                    "207.46.0.0/16".parse().unwrap(),
                    "65.52.0.0/14".parse().unwrap(),
                    "157.55.0.0/16".parse().unwrap(),
                    "157.56.0.0/16".parse().unwrap(),
                ],
            ...
            CompiledBot {
                ...
                ip_ranges: vec![
                    "20.191.45.212/32".parse().unwrap(),
                    "40.88.21.235/32".parse().unwrap(),
                    "40.76.173.151/32".parse().unwrap(),
                    "40.76.163.7/32".parse().unwrap(),
                    "20.185.79.47/32".parse().unwrap(),
                ],
            ...
            CompiledBot {
                ...
                ua_patterns: vec![
                    Regex::new(r"(?i)uptimerobot").unwrap(),
                ],
                ip_ranges: vec![],
                verify_dns: None,
                is_good: true,
    ...
    fn default_bad_patterns() -> Vec<CompiledPattern> {
        vec![
            ...
            CompiledPattern {
                pattern: Regex::new(r"(?i)nikto").unwrap(),
                reason: "security_scanner_nikto".to_string(),
                score: 95,
            },
            CompiledPattern {
                pattern: Regex::new(r"(?i)nessus").unwrap(),
                reason: "security_scanner_nessus".to_string(),
                score: 90,
            },
            CompiledPattern {
                pattern: Regex::new(r"(?i)masscan").unwrap(),
                reason: "port_scanner_masscan".to_string(),
                score: 90,
            },
            CompiledPattern {
                pattern: Regex::new(r"(?i)zgrab").unwrap(),
                reason: "security_scanner_zgrab".to_string(),
                score: 85,
            },
            CompiledPattern {
                pattern: Regex::new(r"(?i)gobuster").unwrap(),
                reason: "directory_scanner_gobuster".to_string(),
                score: 85,
            },
            CompiledPattern {
                pattern: Regex::new(r"(?i)nuclei").unwrap(),
